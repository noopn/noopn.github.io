...
block formatting context (块级格式化上下文)， BFC 元素可以隔离子元素对外部元素的影响。[\[CSS 世界中相关章节\]](https://minioo.iftrue.me/docs/CSS%E4%B8%96%E7%95%8C.pdf#page=175)
...
overflow 属性原本的作用指定了块容器元素的内容溢出时是否需要裁剪。[\[CSS 世界中相关章节\]](https://minioo.iftrue.me/docs/CSS%E4%B8%96%E7%95%8C.pdf#page=179)
...
通常配合变量使用，实现动态计算效果。[\[CSS 新世界 4.5\]](https://minioo.iftrue.me/docs/CSS%E6%96%B0%E4%B8%96%E7%95%8C.pdf#page=280) [\[兼容性\]](https://developer.mozilla.org/en-US/docs/Web/CSS/calc#browser_compatibility)
